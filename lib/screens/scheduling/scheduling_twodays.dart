...
class SchedulingTwodays {
  ...
  static String date() {
    ...
    return "${date.year.toString()}/${date.month.toString()}/${(date.day + 2).toString()}";
  }
  ...
  static Stream<String> streamDate() {
    ...
    Stream<String> streamDate =
      ...
      return "${time.year.toString()}/${time.month.toString()}/${(time.day + 2).toString()}";
    });

    return streamDate;
  }

  static Widget schedulingTwodays(
            ...
            Container(
              ...
              child: Column(
                children: [
                        ...
                        child: Row(
                          children: [
                            ...
                            BlocBuilder<SchedulingCubit, SchedulingState>(
                              ...
                              if (state is SchedulingTwodaysTimeState) {
                  ...
                  BlocBuilder<SchedulingCubit, SchedulingState>(
                      builder: (context, state) {
                    if (state is SchedulingTwodaysState ||
